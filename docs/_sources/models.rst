...
.. function:: caption_image(img: Image, processor, model) -> tuple[str, str]
    ...
    This function generates captions for a given Pillow Image using the specified model.
    ...
    This function generates captions for the input image using the provided model and processor.
